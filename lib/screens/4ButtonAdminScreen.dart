...
class FourButtonAdminScreen extends StatefulWidget {

  const FourButtonAdminScreen(this.s, {super.key});
  final String s;

  @override
  State<FourButtonAdminScreen> createState() => _FourButtonAdminScreenState();
}

class _FourButtonAdminScreenState extends State<FourButtonAdminScreen> {
                        ...
                        ListTile( 
                           title: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                             children: [  
                              Text("Add Lesson", style: TextStyle(color: Colors.white, fontSize: 20,fontWeight: FontWeight.bold),),  
                             ],
                           ),
                            trailing: Icon(Icons.add, color: Colors.white, size: 20,),
                          ),                  
                      ],
                    ),
                  ),
